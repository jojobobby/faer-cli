...
HXLINE( 289)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("open",ca,03,b4,49),null(),null()));
...
HXLINE( 305)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            			}
...
HXLINE( 322)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 382)				 ::openfl::net::URLRequestHeader header = _g2->__get(_g1).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 382)				_g1 = (_g1 + 1);
HXLINE( 384)				( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),::hx::paccDynamic)) )->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 419)			 ::openfl::events::IOErrorEvent event1 =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
