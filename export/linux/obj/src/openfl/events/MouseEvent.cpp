...
static const ::String _hx_array_data_094f3eac_2[] = {
...
HXDLIN( 666)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_2,11));
            	}
