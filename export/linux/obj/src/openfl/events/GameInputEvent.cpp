...
static const ::String _hx_array_data_6a3e74b9_2[] = {
...
HXDLIN(  57)		return this->_hx___formatToString(HX_("GameInputEvent",62,3e,f4,2c),::Array_obj< ::String >::fromData( _hx_array_data_6a3e74b9_2,4));
            	}
