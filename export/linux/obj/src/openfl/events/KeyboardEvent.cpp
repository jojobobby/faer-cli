...
static const ::String _hx_array_data_d8fbaf5c_2[] = {
...
HXDLIN( 198)		return this->_hx___formatToString(HX_("KeyboardEvent",d3,8d,88,91),::Array_obj< ::String >::fromData( _hx_array_data_d8fbaf5c_2,9));
            	}
