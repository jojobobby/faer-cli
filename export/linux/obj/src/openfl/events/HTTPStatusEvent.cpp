...
static const ::String _hx_array_data_61c0a2a9_2[] = {
...
HXDLIN( 144)		return this->_hx___formatToString(HX_("HTTPStatusEvent",e0,4c,1b,fe),::Array_obj< ::String >::fromData( _hx_array_data_61c0a2a9_2,5));
            	}
