...
static const ::String _hx_array_data_60863a29_2[] = {
...
HXDLIN(  92)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_60863a29_2,5));
            	}
