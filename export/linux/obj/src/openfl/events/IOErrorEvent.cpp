...
static const ::String _hx_array_data_1ffe394f_2[] = {
...
HXDLIN( 121)		return this->_hx___formatToString(HX_("IOErrorEvent",b8,16,b3,65),::Array_obj< ::String >::fromData( _hx_array_data_1ffe394f_2,5));
            	}
