...
static const ::String _hx_array_data_e5132ed2_2[] = {
...
HXDLIN( 486)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_2,16));
            	}
