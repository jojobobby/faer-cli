...
HXLINE(  96)				formatMap->set(hash, ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions()));
            			}
            		}
            		else {
HXLINE( 101)			 ::haxe::ds::IntMap formatMap1 =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 102)			 ::openfl::text::_internal::CacheMeasurement measurement1 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 103)			measurement1->hash = hash;
HXLINE( 104)			formatMap1->set(hash,measurement1);
