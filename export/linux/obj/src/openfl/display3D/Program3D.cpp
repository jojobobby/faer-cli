...
HXLINE( 495)		 ::lime::graphics::opengl::GLObject program = this->_hx___glProgram;
HXDLIN( 495)		int numActive1;
HXDLIN( 495)		if (::hx::IsNull( program )) {
HXLINE( 495)			numActive1 = 0;
            		}
            		else {
HXLINE( 495)			numActive1 = program->id;
            		}
HXDLIN( 495)		numActive = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_programi(numActive1,gl->ACTIVE_UNIFORMS);
...
HXLINE( 502)				 ::lime::graphics::opengl::GLObject program1 = this->_hx___glProgram;
HXDLIN( 502)				int info;
HXDLIN( 502)				if (::hx::IsNull( program1 )) {
HXLINE( 502)					info = 0;
            				}
            				else {
HXLINE( 502)					info = program1->id;
            				}
HXDLIN( 502)				 ::Dynamic info1 = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_active_uniform(info,i)) );
HXLINE( 507)				 ::openfl::display3D::Uniform uniform =  ::openfl::display3D::Uniform_obj::__alloc( HX_CTX ,this->_hx___context);
HXLINE( 508)				uniform->name = ( (::String)(info1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXLINE( 509)				uniform->size = ( (int)(info1->__Field(HX_("size",c1,a0,53,4c),::hx::paccDynamic)) );
HXLINE( 510)				uniform->type = ( (int)(info1->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)) );
HXLINE( 512)				 ::lime::graphics::opengl::GLObject program2 = this->_hx___glProgram;
HXDLIN( 512)				int _hx_tmp;
HXDLIN( 512)				if (::hx::IsNull( program2 )) {
HXLINE( 512)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 512)					_hx_tmp = program2->id;
            				}
HXDLIN( 512)				uniform->location = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_uniform_location(_hx_tmp,uniform->name);
...
HXLINE( 553)								_hx_tmp1 = (uniform->name.indexOf(HX_("alpha",5e,a7,96,21),null()) == -1);
            							}
            							else {
...
HXLINE( 597)			{
HXLINE( 597)				 ::lime::graphics::opengl::GLObject shader = this->_hx___glVertexShader;
HXDLIN( 597)				{
HXLINE( 597)					if (::hx::IsNotNull( shader )) {
HXLINE( 597)						::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_deregister(::hx::DynamicPtr(shader));
            					}
HXDLIN( 597)					int _hx_tmp;
HXDLIN( 597)					if (::hx::IsNull( shader )) {
HXLINE( 597)						_hx_tmp = 0;
            					}
            					else {
HXLINE( 597)						_hx_tmp = shader->id;
            					}
HXDLIN( 597)					::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_delete_shader(_hx_tmp);
            				}
            			}
...
HXLINE( 603)			{
HXLINE( 603)				 ::lime::graphics::opengl::GLObject shader1 = this->_hx___glFragmentShader;
HXDLIN( 603)				{
HXLINE( 603)					if (::hx::IsNotNull( shader1 )) {
HXLINE( 603)						::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_deregister(::hx::DynamicPtr(shader1));
            					}
HXDLIN( 603)					int _hx_tmp1;
HXDLIN( 603)					if (::hx::IsNull( shader1 )) {
HXLINE( 603)						_hx_tmp1 = 0;
            					}
            					else {
HXLINE( 603)						_hx_tmp1 = shader1->id;
            					}
HXDLIN( 603)					::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_delete_shader(_hx_tmp1);
            				}
            			}
...
HXLINE( 653)		{
HXLINE( 653)			 ::lime::graphics::opengl::GLObject program = this->_hx___glProgram;
HXDLIN( 653)			{
HXLINE( 653)				this->_hx___context->gl->_hx___currentProgram = program;
HXDLIN( 653)				int _hx_tmp;
HXDLIN( 653)				if (::hx::IsNull( program )) {
HXLINE( 653)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 653)					_hx_tmp = program->id;
            				}
HXDLIN( 653)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_use_program(_hx_tmp);
            			}
            		}
...
HXLINE( 664)						::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform1i(val->location,val->regIndex);
            					}
            					else {
...
HXLINE( 676)						::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform1i(val1->location,val1->regIndex);
            					}
            					else {
...
HXDLIN( 844)			{
HXLINE( 844)				int count;
HXDLIN( 844)				if (::hx::IsNotNull( positionScale )) {
HXLINE( 844)					count = (positionScale->length >> 2);
            				}
            				else {
HXLINE( 844)					count = 0;
            				}
HXDLIN( 844)				Float v = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromArrayBufferView(positionScale);
HXDLIN( 844)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform4fv(location,count,v);
            			}
            		}
            	}
...
HXLINE( 860)		int id = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_create_shader(gl->VERTEX_SHADER);
HXDLIN( 860)		 ::lime::graphics::opengl::GLObject _hx_tmp;
HXDLIN( 860)		if ((id == 0)) {
HXLINE( 860)			_hx_tmp = null();
            		}
            		else {
HXLINE( 860)			 ::lime::graphics::opengl::GLObject object =  ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id);
HXDLIN( 860)			object->ptr = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,2,::hx::DynamicPtr(object))) );
HXDLIN( 860)			_hx_tmp = object;
            		}
HXDLIN( 860)		this->_hx___glVertexShader = _hx_tmp;
HXLINE( 861)		{
HXLINE( 861)			 ::lime::graphics::opengl::GLObject shader = this->_hx___glVertexShader;
HXDLIN( 861)			int _hx_tmp1;
HXDLIN( 861)			if (::hx::IsNull( shader )) {
HXLINE( 861)				_hx_tmp1 = 0;
            			}
            			else {
HXLINE( 861)				_hx_tmp1 = shader->id;
            			}
HXDLIN( 861)			::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_shader_source(_hx_tmp1,vertexShaderSource);
            		}
HXLINE( 862)		{
HXLINE( 862)			 ::lime::graphics::opengl::GLObject shader1 = this->_hx___glVertexShader;
HXDLIN( 862)			int _hx_tmp2;
HXDLIN( 862)			if (::hx::IsNull( shader1 )) {
HXLINE( 862)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE( 862)				_hx_tmp2 = shader1->id;
            			}
HXDLIN( 862)			::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_compile_shader(_hx_tmp2);
            		}
HXLINE( 864)		 ::lime::graphics::opengl::GLObject shader2 = this->_hx___glVertexShader;
HXDLIN( 864)		int _hx_tmp3;
HXDLIN( 864)		if (::hx::IsNull( shader2 )) {
HXLINE( 864)			_hx_tmp3 = 0;
            		}
            		else {
HXLINE( 864)			_hx_tmp3 = shader2->id;
            		}
HXDLIN( 864)		if ((::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shaderi(_hx_tmp3,gl->COMPILE_STATUS) == 0)) {
HXLINE( 866)			::String message = HX_("Error compiling vertex shader",39,c9,c1,b2);
HXLINE( 867)			 ::lime::graphics::opengl::GLObject shader3 = this->_hx___glVertexShader;
HXDLIN( 867)			int result;
HXDLIN( 867)			if (::hx::IsNull( shader3 )) {
HXLINE( 867)				result = 0;
            			}
            			else {
HXLINE( 867)				result = shader3->id;
            			}
HXDLIN( 867)			message = (HX_("Error compiling vertex shader",39,c9,c1,b2) + (HX_("\n",0a,00,00,00) + ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shader_info_log(result)) )) )));
...
HXLINE( 872)		int id1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_create_shader(gl->FRAGMENT_SHADER);
HXDLIN( 872)		 ::lime::graphics::opengl::GLObject _hx_tmp4;
HXDLIN( 872)		if ((id1 == 0)) {
HXLINE( 872)			_hx_tmp4 = null();
            		}
            		else {
HXLINE( 872)			 ::lime::graphics::opengl::GLObject object1 =  ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id1);
HXDLIN( 872)			object1->ptr = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id1,2,::hx::DynamicPtr(object1))) );
HXDLIN( 872)			_hx_tmp4 = object1;
            		}
HXDLIN( 872)		this->_hx___glFragmentShader = _hx_tmp4;
HXLINE( 873)		{
HXLINE( 873)			 ::lime::graphics::opengl::GLObject shader4 = this->_hx___glFragmentShader;
HXDLIN( 873)			int _hx_tmp5;
HXDLIN( 873)			if (::hx::IsNull( shader4 )) {
HXLINE( 873)				_hx_tmp5 = 0;
            			}
            			else {
HXLINE( 873)				_hx_tmp5 = shader4->id;
            			}
HXDLIN( 873)			::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_shader_source(_hx_tmp5,fragmentShaderSource);
            		}
HXLINE( 874)		{
HXLINE( 874)			 ::lime::graphics::opengl::GLObject shader5 = this->_hx___glFragmentShader;
HXDLIN( 874)			int _hx_tmp6;
HXDLIN( 874)			if (::hx::IsNull( shader5 )) {
HXLINE( 874)				_hx_tmp6 = 0;
            			}
            			else {
HXLINE( 874)				_hx_tmp6 = shader5->id;
            			}
HXDLIN( 874)			::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_compile_shader(_hx_tmp6);
            		}
HXLINE( 876)		 ::lime::graphics::opengl::GLObject shader6 = this->_hx___glFragmentShader;
HXDLIN( 876)		int _hx_tmp7;
HXDLIN( 876)		if (::hx::IsNull( shader6 )) {
HXLINE( 876)			_hx_tmp7 = 0;
            		}
            		else {
HXLINE( 876)			_hx_tmp7 = shader6->id;
            		}
HXDLIN( 876)		if ((::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shaderi(_hx_tmp7,gl->COMPILE_STATUS) == 0)) {
HXLINE( 878)			::String message1 = HX_("Error compiling fragment shader",4d,d0,be,e3);
HXLINE( 879)			 ::lime::graphics::opengl::GLObject shader7 = this->_hx___glFragmentShader;
HXDLIN( 879)			int result1;
HXDLIN( 879)			if (::hx::IsNull( shader7 )) {
HXLINE( 879)				result1 = 0;
            			}
            			else {
HXLINE( 879)				result1 = shader7->id;
            			}
HXDLIN( 879)			message1 = (HX_("Error compiling fragment shader",4d,d0,be,e3) + (HX_("\n",0a,00,00,00) + ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_shader_info_log(result1)) )) )));
...
HXLINE( 884)		int id2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_create_program();
HXDLIN( 884)		 ::lime::graphics::opengl::GLObject _hx_tmp8;
HXDLIN( 884)		if ((id2 == 0)) {
HXLINE( 884)			_hx_tmp8 = null();
            		}
            		else {
HXLINE( 884)			 ::lime::graphics::opengl::GLObject object2 =  ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id2);
HXDLIN( 884)			object2->ptr = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id2,1,::hx::DynamicPtr(object2))) );
HXDLIN( 884)			_hx_tmp8 = object2;
            		}
HXDLIN( 884)		this->_hx___glProgram = _hx_tmp8;
...
HXLINE( 897)					 ::lime::graphics::opengl::GLObject program = this->_hx___glProgram;
HXDLIN( 897)					int _hx_tmp9;
HXDLIN( 897)					if (::hx::IsNull( program )) {
HXLINE( 897)						_hx_tmp9 = 0;
            					}
            					else {
HXLINE( 897)						_hx_tmp9 = program->id;
            					}
HXDLIN( 897)					::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_bind_attrib_location(_hx_tmp9,i,name);
            				}
            			}
            		}
            		else {
...
HXLINE( 906)				bool _hx_tmp10;
HXDLIN( 906)				if ((name1.indexOf(HX_("Position",c9,5c,ac,a4),null()) > -1)) {
HXLINE( 906)					_hx_tmp10 = ::StringTools_obj::startsWith(name1,HX_("openfl_",cf,ba,42,40));
            				}
            				else {
HXLINE( 906)					_hx_tmp10 = false;
            				}
HXDLIN( 906)				if (_hx_tmp10) {
HXLINE( 908)					{
HXLINE( 908)						 ::lime::graphics::opengl::GLObject program1 = this->_hx___glProgram;
HXDLIN( 908)						int _hx_tmp11;
HXDLIN( 908)						if (::hx::IsNull( program1 )) {
HXLINE( 908)							_hx_tmp11 = 0;
            						}
            						else {
HXLINE( 908)							_hx_tmp11 = program1->id;
            						}
HXDLIN( 908)						::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_bind_attrib_location(_hx_tmp11,0,name1);
            					}
HXLINE( 909)					goto _hx_goto_15;
            				}
            			}
            			_hx_goto_15:;
            		}
HXLINE( 914)		{
HXLINE( 914)			 ::lime::graphics::opengl::GLObject program2 = this->_hx___glProgram;
HXDLIN( 914)			 ::lime::graphics::opengl::GLObject shader8 = this->_hx___glVertexShader;
HXDLIN( 914)			{
HXLINE( 914)				bool _hx_tmp12;
HXDLIN( 914)				if (::hx::IsNotNull( program2 )) {
HXLINE( 914)					_hx_tmp12 = ::hx::IsNotNull( shader8 );
            				}
            				else {
HXLINE( 914)					_hx_tmp12 = false;
            				}
HXDLIN( 914)				if (_hx_tmp12) {
HXLINE( 914)					if (::hx::IsNull( program2->refs )) {
HXLINE( 914)						program2->refs = ::Array_obj< ::Dynamic>::__new(1)->init(0,shader8);
            					}
            					else {
HXLINE( 914)						if ((program2->refs->indexOf(shader8,null()) == -1)) {
HXLINE( 914)							program2->refs->push(shader8);
            						}
            					}
            				}
HXDLIN( 914)				int _hx_tmp13;
HXDLIN( 914)				if (::hx::IsNull( program2 )) {
HXLINE( 914)					_hx_tmp13 = 0;
            				}
            				else {
HXLINE( 914)					_hx_tmp13 = program2->id;
            				}
HXDLIN( 914)				int _hx_tmp14;
HXDLIN( 914)				if (::hx::IsNull( shader8 )) {
HXLINE( 914)					_hx_tmp14 = 0;
            				}
            				else {
HXLINE( 914)					_hx_tmp14 = shader8->id;
            				}
HXDLIN( 914)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_attach_shader(_hx_tmp13,_hx_tmp14);
            			}
            		}
HXLINE( 915)		{
HXLINE( 915)			 ::lime::graphics::opengl::GLObject program3 = this->_hx___glProgram;
HXDLIN( 915)			 ::lime::graphics::opengl::GLObject shader9 = this->_hx___glFragmentShader;
HXDLIN( 915)			{
HXLINE( 915)				bool _hx_tmp15;
HXDLIN( 915)				if (::hx::IsNotNull( program3 )) {
HXLINE( 915)					_hx_tmp15 = ::hx::IsNotNull( shader9 );
            				}
            				else {
HXLINE( 915)					_hx_tmp15 = false;
            				}
HXDLIN( 915)				if (_hx_tmp15) {
HXLINE( 915)					if (::hx::IsNull( program3->refs )) {
HXLINE( 915)						program3->refs = ::Array_obj< ::Dynamic>::__new(1)->init(0,shader9);
            					}
            					else {
HXLINE( 915)						if ((program3->refs->indexOf(shader9,null()) == -1)) {
HXLINE( 915)							program3->refs->push(shader9);
            						}
            					}
            				}
HXDLIN( 915)				int _hx_tmp16;
HXDLIN( 915)				if (::hx::IsNull( program3 )) {
HXLINE( 915)					_hx_tmp16 = 0;
            				}
            				else {
HXLINE( 915)					_hx_tmp16 = program3->id;
            				}
HXDLIN( 915)				int _hx_tmp17;
HXDLIN( 915)				if (::hx::IsNull( shader9 )) {
HXLINE( 915)					_hx_tmp17 = 0;
            				}
            				else {
HXLINE( 915)					_hx_tmp17 = shader9->id;
            				}
HXDLIN( 915)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_attach_shader(_hx_tmp16,_hx_tmp17);
            			}
            		}
HXLINE( 916)		{
HXLINE( 916)			 ::lime::graphics::opengl::GLObject program4 = this->_hx___glProgram;
HXDLIN( 916)			int _hx_tmp18;
HXDLIN( 916)			if (::hx::IsNull( program4 )) {
HXLINE( 916)				_hx_tmp18 = 0;
            			}
            			else {
HXLINE( 916)				_hx_tmp18 = program4->id;
            			}
HXDLIN( 916)			::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_link_program(_hx_tmp18);
            		}
HXLINE( 918)		 ::lime::graphics::opengl::GLObject program5 = this->_hx___glProgram;
HXDLIN( 918)		int _hx_tmp19;
HXDLIN( 918)		if (::hx::IsNull( program5 )) {
HXLINE( 918)			_hx_tmp19 = 0;
            		}
            		else {
HXLINE( 918)			_hx_tmp19 = program5->id;
            		}
HXDLIN( 918)		if ((::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_programi(_hx_tmp19,gl->LINK_STATUS) == 0)) {
HXLINE( 920)			::String message2 = HX_("Unable to initialize the shader program",f0,86,8b,39);
HXLINE( 921)			 ::lime::graphics::opengl::GLObject program6 = this->_hx___glProgram;
HXDLIN( 921)			int result2;
HXDLIN( 921)			if (::hx::IsNull( program6 )) {
HXLINE( 921)				result2 = 0;
            			}
            			else {
HXLINE( 921)				result2 = program6->id;
            			}
HXDLIN( 921)			message2 = (HX_("Unable to initialize the shader program",f0,86,8b,39) + (HX_("\n",0a,00,00,00) + ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_program_info_log(result2)) )) )));
