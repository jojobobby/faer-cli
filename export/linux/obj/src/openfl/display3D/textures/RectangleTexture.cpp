...
HXDLIN( 119)				{
HXLINE( 119)					Float data1 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer);
HXDLIN( 119)					::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_tex_image_2d(target,0,internalformat,width,height,0,format,type,data1);
            				}
            			}
            		}
...
HXLINE( 145)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_tex_parameterf(gl->TEXTURE_2D,::openfl::display3D::Context3D_obj::_hx___glTextureMaxAnisotropy,( (float)(aniso) ));
            			}
