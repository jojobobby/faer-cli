...
HXDLIN(  49)				{
HXLINE(  49)					Float data = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer);
HXDLIN(  49)					::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_tex_image_2d(target,0,internalformat,width1,height1,0,format1,type,data);
            				}
            			}
            		}
...
HXLINE( 270)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_generate_mipmap(gl->TEXTURE_2D);
...
HXLINE( 290)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_tex_parameterf(gl->TEXTURE_2D,::openfl::display3D::Context3D_obj::_hx___glTextureMaxAnisotropy,( (float)(aniso) ));
            			}
