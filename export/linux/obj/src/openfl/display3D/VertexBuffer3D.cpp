...
HXLINE(  72)		int id = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_create_buffer();
HXDLIN(  72)		 ::lime::graphics::opengl::GLObject _hx_tmp;
HXDLIN(  72)		if ((id == 0)) {
HXLINE(  72)			_hx_tmp = null();
            		}
            		else {
HXLINE(  72)			 ::lime::graphics::opengl::GLObject object =  ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id);
HXDLIN(  72)			object->ptr = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,3,::hx::DynamicPtr(object))) );
HXDLIN(  72)			_hx_tmp = object;
            		}
HXDLIN(  72)		this->_hx___id = _hx_tmp;
HXLINE(  73)		this->_hx___stride = (this->_hx___vertexSize * 4);
HXLINE(  74)		int _hx_tmp1;
HXDLIN(  74)		if (::hx::IsEq( ::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::fromString(bufferUsage),0 )) {
HXLINE(  74)			_hx_tmp1 = gl->DYNAMIC_DRAW;
            		}
            		else {
HXLINE(  74)			_hx_tmp1 = gl->STATIC_DRAW;
            		}
HXDLIN(  74)		this->_hx___usage = _hx_tmp1;
            	}
