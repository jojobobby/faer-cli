...
HXDLIN( 994)				Float v = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 994)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform2fv(location,count,v);
            			}
            			break;
            			case (int)35665: {
...
HXDLIN( 996)				Float v1 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 996)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform3fv(location1,count1,v1);
            			}
            			break;
            			case (int)35666: {
...
HXDLIN( 998)				Float v2 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 998)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform4fv(location2,count2,v2);
            			}
            			break;
            			case (int)35674: {
...
HXDLIN( 988)				Float v3 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 988)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform_matrix2fv(location3,count3,false,v3);
            			}
            			break;
            			case (int)35675: {
...
HXDLIN( 990)				Float v4 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 990)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform_matrix3fv(location4,count4,false,v4);
            			}
            			break;
            			case (int)35676: {
...
HXDLIN( 992)				Float v5 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN( 992)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform_matrix4fv(location5,count5,false,v5);
            			}
            			break;
            			default:{
...
HXDLIN(1000)				Float v6 = ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(this->regDataPointer);
HXDLIN(1000)				::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_uniform4fv(location6,count6,v6);
            			}
            		}
            	}
