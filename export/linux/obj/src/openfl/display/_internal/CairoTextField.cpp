...
HXLINE( 389)												selectedGylphs->push(glyphs->__get((_g8 - 1)).StaticCast<  ::lime::graphics::cairo::CairoGlyph >());
            											}
            										}
...
HXLINE( 404)							Float x1 = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 405)							Float y1 = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + ::Math_obj::floor((group1->ascent * ((Float)0.185)))) + ((Float)0.5));
...
HXDLIN( 416)				Float scrollX2 = (-(textField->get_scrollH()) + scrollX1);
HXLINE( 417)				Float scrollY2 = ((Float)0.0);
HXLINE( 419)				{
HXLINE( 419)					int _g10 = 0;
HXDLIN( 419)					int _g11 = (textField->get_scrollV() - 1);
HXDLIN( 419)					while((_g10 < _g11)){
HXLINE( 419)						_g10 = (_g10 + 1);
HXLINE( 421)						scrollY2 = (scrollY2 + textEngine->lineHeights->get((_g10 - 1)));
            					}
            				}
HXLINE( 424)				 ::Dynamic color3 = textField->get_defaultTextFormat()->color;
HXLINE( 429)				cairo->setSourceRGB((( (Float)(::hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) )),(( (Float)(::hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) )),(( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) )));
