...
HXLINE( 604)		this->a = (this->a * sx);
HXLINE( 605)		this->b = (this->b * sy);
HXLINE( 606)		this->c = (this->c * sx);
HXLINE( 607)		this->d = (this->d * sy);
HXLINE( 608)		this->tx = (this->tx * sx);
HXLINE( 609)		this->ty = (this->ty * sy);
            	}
...
HXLINE( 698)		this->tx = (this->tx + dx);
HXLINE( 699)		this->ty = (this->ty + dy);
            	}
