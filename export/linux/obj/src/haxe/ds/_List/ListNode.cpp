...
HX_DEFINE_STACK_FRAME(_hx_pos_8ae1b4f73ef25096_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/home/a/haxe/haxe/std/haxe/ds/List.hx",266,0x7ebe40ce)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_8ae1b4f73ef25096_266_new)
