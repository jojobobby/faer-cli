...
HX_DEFINE_STACK_FRAME(_hx_pos_d52b7b1f8026d465_71_new,"haxe.http.HttpBase","new",0x98384fa9,"haxe.http.HttpBase.new","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",71,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_112_setParameter,"haxe.http.HttpBase","setParameter",0x7f4fc53e,"haxe.http.HttpBase.setParameter","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",112,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_196___default_onData,"haxe.http.HttpBase","__default_onData",0xb2f8141e,"haxe.http.HttpBase.__default_onData","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",196,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_205___default_onBytes,"haxe.http.HttpBase","__default_onBytes",0xcf297ff7,"haxe.http.HttpBase.__default_onBytes","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",205,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_214___default_onError,"haxe.http.HttpBase","__default_onError",0x84bb4354,"haxe.http.HttpBase.__default_onError","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",214,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_223___default_onStatus,"haxe.http.HttpBase","__default_onStatus",0x53b30a26,"haxe.http.HttpBase.__default_onStatus","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",223,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_229_hasOnData,"haxe.http.HttpBase","hasOnData",0xc242adec,"haxe.http.HttpBase.hasOnData","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",229,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_232_success,"haxe.http.HttpBase","success",0xfe1e7d8c,"haxe.http.HttpBase.success","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",232,0x58a6184c)
HX_LOCAL_STACK_FRAME(_hx_pos_d52b7b1f8026d465_241_get_responseData,"haxe.http.HttpBase","get_responseData",0x92ecd8eb,"haxe.http.HttpBase.get_responseData","/home/a/haxe/haxe/std/haxe/http/HttpBase.hx",241,0x58a6184c)
namespace haxe{
namespace http{

void HttpBase_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_71_new)
...
void HttpBase_obj::setParameter(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_112_setParameter)
HXLINE( 113)		{
HXLINE( 113)			int _g = 0;
...
void _hx_run(::String data){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_196___default_onData)
            	}
...
void _hx_run( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_205___default_onBytes)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(::String msg){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_214___default_onError)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(int status){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_223___default_onStatus)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

bool HttpBase_obj::hasOnData(){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_229_hasOnData)
...
void HttpBase_obj::success( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_232_success)
...
::String HttpBase_obj::get_responseData(){
            	HX_STACKFRAME(&_hx_pos_d52b7b1f8026d465_241_get_responseData)
