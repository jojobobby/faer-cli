...
HX_DEFINE_STACK_FRAME(_hx_pos_d95044f5b0082146_40_new,"haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","/home/a/haxe/haxe/std/haxe/io/BytesOutput.hx",40,0x5969980d)
HX_LOCAL_STACK_FRAME(_hx_pos_d95044f5b0082146_55_writeByte,"haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","/home/a/haxe/haxe/std/haxe/io/BytesOutput.hx",55,0x5969980d)
HX_LOCAL_STACK_FRAME(_hx_pos_d95044f5b0082146_59_writeBytes,"haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","/home/a/haxe/haxe/std/haxe/io/BytesOutput.hx",59,0x5969980d)
HX_LOCAL_STACK_FRAME(_hx_pos_d95044f5b0082146_143_getBytes,"haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","/home/a/haxe/haxe/std/haxe/io/BytesOutput.hx",143,0x5969980d)
namespace haxe{
namespace io{

void BytesOutput_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d95044f5b0082146_40_new)
...
void BytesOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_d95044f5b0082146_55_writeByte)
HXDLIN(  55)		this->b->b->push(c);
            	}


int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_d95044f5b0082146_59_writeBytes)
HXLINE(  65)		{
...
HXLINE(  67)		return len;
 ...
 ::haxe::io::Bytes BytesOutput_obj::getBytes(){
            	HX_STACKFRAME(&_hx_pos_d95044f5b0082146_143_getBytes)
