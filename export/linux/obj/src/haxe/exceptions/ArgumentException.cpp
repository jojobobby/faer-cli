...
HX_DEFINE_STACK_FRAME(_hx_pos_98e7f5bc2f8913ac_12_new,"haxe.exceptions.ArgumentException","new",0x0586be82,"haxe.exceptions.ArgumentException.new","/home/a/haxe/haxe/std/haxe/exceptions/ArgumentException.hx",12,0xa1dde9a9)
namespace haxe{
namespace exceptions{

void ArgumentException_obj::__construct(::String argument,::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_98e7f5bc2f8913ac_12_new)
HXDLIN(  12)		{
