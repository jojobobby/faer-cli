...
HX_LOCAL_STACK_FRAME(_hx_pos_0def2a3d0f732673_115_parse,"haxe.xml.Parser","parse",0x937905c3,"haxe.xml.Parser.parse","/home/a/haxe/haxe/std/haxe/xml/Parser.hx",115,0x5d3ed8d9)
HX_LOCAL_STACK_FRAME(_hx_pos_0def2a3d0f732673_121_doParse,"haxe.xml.Parser","doParse",0x2e9a6a38,"haxe.xml.Parser.doParse","/home/a/haxe/haxe/std/haxe/xml/Parser.hx",121,0x5d3ed8d9)
HX_LOCAL_STACK_FRAME(_hx_pos_0def2a3d0f732673_100_boot,"haxe.xml.Parser","boot",0x0af6f0a2,"haxe.xml.Parser.boot","/home/a/haxe/haxe/std/haxe/xml/Parser.hx",100,0x5d3ed8d9)
namespace haxe{
namespace xml{
...
bool Parser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml Parser_obj::parse(::String str,::hx::Null< bool >  __o_strict){
            	...
            	HX_STACKFRAME(&_hx_pos_0def2a3d0f732673_115_parse)
...
int Parser_obj::doParse(::String str,bool strict,::hx::Null< int >  __o_p, ::Xml parent){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_0def2a3d0f732673_121_doParse)
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::haxe::ds::StringMap _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_0def2a3d0f732673_100_boot)
...
HXLINE( 107)			return h;
            	...
            	HX_STACKFRAME(&_hx_pos_0def2a3d0f732673_100_boot)
