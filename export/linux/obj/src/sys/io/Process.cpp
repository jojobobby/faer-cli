...
HX_DEFINE_STACK_FRAME(_hx_pos_74a1559bc2d4f5df_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","/home/a/haxe/haxe/std/cpp/_std/sys/io/Process.hx",94,0xa1339432)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_74a1559bc2d4f5df_94_new)
