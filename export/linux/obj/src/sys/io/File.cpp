...
HX_LOCAL_STACK_FRAME(_hx_pos_4edec8714a8399ef_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","/home/a/haxe/haxe/std/cpp/_std/sys/io/File.hx",30,0xe2f9055f)
HX_LOCAL_STACK_FRAME(_hx_pos_4edec8714a8399ef_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","/home/a/haxe/haxe/std/cpp/_std/sys/io/File.hx",44,0xe2f9055f)
HX_LOCAL_STACK_FRAME(_hx_pos_4edec8714a8399ef_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/a/haxe/haxe/std/cpp/_std/sys/io/File.hx",51,0xe2f9055f)
HX_LOCAL_STACK_FRAME(_hx_pos_4edec8714a8399ef_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","/home/a/haxe/haxe/std/cpp/_std/sys/io/File.hx",55,0xe2f9055f)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_4edec8714a8399ef_30_getContent)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_4edec8714a8399ef_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,saveBytes,(void))
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4edec8714a8399ef_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_4edec8714a8399ef_55_write)
