...
HX_DEFINE_STACK_FRAME(_hx_pos_3f916bf5b633ae23_78_new,"sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","/home/a/haxe/haxe/std/cpp/_std/sys/net/Socket.hx",78,0x2acabef3)
HX_LOCAL_STACK_FRAME(_hx_pos_3f916bf5b633ae23_81_writeByte,"sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","/home/a/haxe/haxe/std/cpp/_std/sys/net/Socket.hx",81,0x2acabef3)
HX_LOCAL_STACK_FRAME(_hx_pos_3f916bf5b633ae23_95_writeBytes,"sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","/home/a/haxe/haxe/std/cpp/_std/sys/net/Socket.hx",95,0x2acabef3)
HX_LOCAL_STACK_FRAME(_hx_pos_3f916bf5b633ae23_107_close,"sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","/home/a/haxe/haxe/std/cpp/_std/sys/net/Socket.hx",107,0x2acabef3)
namespace sys{
namespace net{
namespace _Socket{

void SocketOutput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_3f916bf5b633ae23_78_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_3f916bf5b633ae23_81_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_3f916bf5b633ae23_95_writeBytes)
HXDLIN(  95)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_3f916bf5b633ae23_107_close)
