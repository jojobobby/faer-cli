...
HX_LOCAL_STACK_FRAME(_hx_pos_09a297b77eeaa12f_54_get_events,"sys.thread._Thread.Thread_Impl_","get_events",0x2940127e,"sys.thread._Thread.Thread_Impl_.get_events","/home/a/haxe/haxe/std/cpp/_std/sys/thread/Thread.hx",54,0x4f354df5)
HX_LOCAL_STACK_FRAME(_hx_pos_09a297b77eeaa12f_62_processEvents,"sys.thread._Thread.Thread_Impl_","processEvents",0xf30238cc,"sys.thread._Thread.Thread_Impl_.processEvents","/home/a/haxe/haxe/std/cpp/_std/sys/thread/Thread.hx",62,0x4f354df5)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::EventLoop Thread_Impl__obj::get_events( ::sys::thread::_Thread::HaxeThread this1){
            	HX_GC_STACKFRAME(&_hx_pos_09a297b77eeaa12f_54_get_events)
...
void Thread_Impl__obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_09a297b77eeaa12f_62_processEvents)
