...
HX_DEFINE_STACK_FRAME(_hx_pos_53db90fb845f9202_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/home/a/haxe/haxe/std/sys/thread/EventLoop.hx",278,0x6f36e668)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_53db90fb845f9202_278_new)
