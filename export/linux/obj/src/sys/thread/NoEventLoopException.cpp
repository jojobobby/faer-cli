...
HX_DEFINE_STACK_FRAME(_hx_pos_48dc44c4edca5e4b_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","/home/a/haxe/haxe/std/sys/thread/NoEventLoopException.hx",7,0xd4a43104)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_48dc44c4edca5e4b_7_new)
HXDLIN(   7)		{
