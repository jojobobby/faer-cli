...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_296_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",296,0xf6fabaad)
...
HXDLIN( 127)			if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 127)			{
HXLINE( 127)				newByteLength = bufferByteLength;
...
HXDLIN( 176)			if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 176)			{
HXLINE( 176)				newByteLength = bufferByteLength;
...
HXLINE( 298)			return null();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_296_loadFromFile)
HXDLIN( 296)		return  ::lime::net::_HTTPRequest_lime_media_AudioBuffer_obj::__alloc( HX_CTX ,null())->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
