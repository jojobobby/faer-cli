...
HXLINE( 397)				_hx_tmp = !(::StringTools_obj::endsWith(path,HX_("/",2f,00,00,00)));
            			}
            			else {
HXLINE( 397)				_hx_tmp = false;
            			}
HXDLIN( 397)			if (_hx_tmp) {
HXLINE( 399)				path = (path + HX_("/",2f,00,00,00));
            			}
...
HXLINE( 464)					if (::StringTools_obj::startsWith(parameter1,HX_("--window-",dd,62,c2,0a))) {
HXLINE( 466)						::String _hx_switch_0 = parameter1.substr(HX_("--window-",dd,62,c2,0a).length,null());
...
HXLINE( 684)			 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 684)				if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 684)				{
HXLINE( 684)					newByteLength = bufferByteLength;
...
HXLINE( 685)			 ::lime::utils::ArrayBufferView this2;
...
HXDLIN( 685)				if ((::hx::Mod(0,_this1->bytesPerElement) != 0)) {
...
HXDLIN( 685)				{
HXLINE( 685)					newByteLength1 = bufferByteLength1;
...
HXDLIN( 685)				_this1->byteOffset = 0;
