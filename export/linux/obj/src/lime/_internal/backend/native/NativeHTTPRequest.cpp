...
HXLINE( 468)		( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) )->error( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic)));
