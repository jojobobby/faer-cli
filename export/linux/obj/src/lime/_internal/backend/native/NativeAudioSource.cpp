...
HXLINE( 104)			::cpp::Int64 x = this->parent->buffer->_hx___srcVorbisFile->pcmTotal(null());
...
HXLINE( 215)		 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 215)		 ::lime::utils::ArrayBufferView buffer = this1;
...
HXLINE( 228)			if ((4096 > (length - total))) {
...
HXLINE( 241)				goto _hx_goto_7;
            			}
            		}
            		_hx_goto_7:;
HXLINE( 245)		return buffer;
            	}
...
HXLINE( 384)					int time3 = ::Std_obj::_hx_int((((( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) )) * (( (Float)(offset) ) / ( (Float)(this->dataLength) ))) * ( (Float)(1000) )));
...
HXLINE( 428)					int totalOffset = ::Std_obj::_hx_int((( (Float)(this->dataLength) ) * (secondOffset / totalSeconds)));
