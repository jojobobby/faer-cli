...
HXLINE( 258)			int keyCode = ::Std_obj::_hx_int(this->keyEventInfo->keyCode);
...
HXLINE( 387)							{
HXLINE( 387)								 ::lime::_internal::backend::native::NativeOpenGLRenderContext _this = gl;
HXDLIN( 387)								_this->_hx___isContextLost = true;
HXDLIN( 387)								_this->_hx___arrayBufferBinding = null();
HXDLIN( 387)								_this->_hx___elementBufferBinding = null();
HXDLIN( 387)								_this->_hx___currentProgram = null();
HXDLIN( 387)								_this->_hx___framebufferBinding = null();
HXDLIN( 387)								_this->_hx___renderbufferBinding = null();
HXDLIN( 387)								_this->_hx___texture2DBinding = null();
HXDLIN( 387)								_this->_hx___textureCubeMapBinding = null();
            							}
...
HXLINE( 577)					_g = (_g + 1);
HXLINE( 579)					timer = ::haxe::Timer_obj::sRunningTimers->__get((_g - 1)).StaticCast<  ::haxe::Timer >();
...
HXLINE( 585)							timer->mFireAt = (timer->mFireAt + timer->mTime);
...
HXLINE( 597)				::Array< ::Dynamic> _this = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 597)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 597)				{
HXLINE( 597)					int _g3 = 0;
HXDLIN( 597)					while((_g3 < _this->length)){
HXLINE( 597)						 ::haxe::Timer v = _this->__get(_g3).StaticCast<  ::haxe::Timer >();
