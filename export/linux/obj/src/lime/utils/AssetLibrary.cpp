...
HXLINE( 631)				this->bytesLoaded = (this->bytesLoaded + size);
            			}
            			else {
HXLINE( 635)				 ::Dynamic cache = this->bytesLoadedCache->get(id);
HXLINE( 637)				if (::hx::IsLess( cache,size )) {
HXLINE( 639)					this->bytesLoaded = (this->bytesLoaded + (( (int)(size) ) - ( (int)(cache) )));
            				}
            			}
...
HXLINE( 772)					int _hx_tmp2 = this->bytesTotal;
HXDLIN( 772)					this->bytesTotal = (_hx_tmp2 + this->sizes->get(id));
            				}
            			}
            		}
            	}
...
HXLINE( 943)					this->bytesLoaded = (this->bytesLoaded + (bytesLoaded - ( (int)(cache) )));
            				}
            			}
            			else {
HXLINE( 948)				this->bytesLoaded = (this->bytesLoaded + bytesLoaded);
            			}
