...
HXLINE(1407)			r->width = (r->width - -(r->x));
...
HXLINE(1415)			r->height = (r->height - -(r->y));
...
HXLINE(1423)			r->width = (r->width - ((r->x + r->width) - ( (Float)(this->width) )));
HXLINE(1425)			if ((r->width <= 0)) {
HXLINE(1425)				return null();
            			}
            		}
HXLINE(1428)		if (((r->y + r->height) >= this->height)) {
HXLINE(1430)			r->height = (r->height - ((r->y + r->height) - ( (Float)(this->height) )));
...
HXDLIN(1502)			{
HXLINE(1502)				newByteLength = bufferByteLength;
...
HXDLIN(1628)				{
HXLINE(1628)					newByteLength = bufferByteLength;
...
HXLINE(1054)		return  ::lime::net::_HTTPRequest_lime_graphics_Image_obj::__alloc( HX_CTX ,null())->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
