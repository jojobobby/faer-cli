...
HXLINE(  49)				::ManifestResources_obj::rootPath = (::ManifestResources_obj::rootPath + HX_("/",2f,00,00,00));
            			}
            		}
HXLINE(  55)		if (::hx::IsNull( ::ManifestResources_obj::rootPath )) {
HXLINE(  64)			::ManifestResources_obj::rootPath = HX_("./",41,28,00,00);
            		}
HXLINE(  70)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_faerbold_ttf >());
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_ubuntu_medium_ttf >());
HXLINE(  72)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_ubuntu_bold_ttf >());
HXLINE(  73)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_ubuntu_mediumitalic_ttf >());
HXLINE(  74)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_faer_ttf >());
HXLINE(  75)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_ubuntu_bolditalic_ttf >());
HXLINE(  92)		::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),(::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42)));
...
HXLINE(  97)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
